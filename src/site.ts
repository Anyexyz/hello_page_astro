export const Site = {
    title: "上网导航 - Hello！",
    keywords: "导航页,Anye,Anyeの小站,百度搜索,哔哩哔哩搜索,知乎搜索,导航网站导航,上网导航",
    description: "这是一个简单的导航页，用于快速访问常用网站。",
    author: "Anye",
    ...
    yiyan: [
        ...
        "人未己知，不可急求其知；人未己合，不可急与之合。——《格言联璧•接物类》",
        "久雨寒蝉少，空山落叶深。——秘演《山中》",
        ...
        "君见恶，则群臣匿端；君见好，则群臣诬能。——《韩非子•二柄》",
        "盖世功劳，当不得一个“矜”字。弥天罪恶，当不得一个“悔”字。——《格言联璧•持躬类》",
        "慢藏诲盗，冶容诲淫。——《周易•系辞传上•第八章》",
